package com.vikram.redactorve.videoconverter;
...
public class VideoConverteractivity extends AppCompatActivity implements OnSeekBarChangeListener {
    ...
    private class a {
        ...
        public int a(String str, String str2, String str3, String str4) {
            ...
            try {
                FFmpeg.getInstance(VideoConverteractivity.this.getApplicationContext()).execute(strArr, new ExecuteBinaryResponseHandler() {
                    ...
                    @Override public void onProgress(String str) {
                        ...
                        sb.append(strArr);
                        ProgressDialog progressDialog = VideoConverteractivity.this.g;

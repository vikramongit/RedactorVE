package com.vikram.redactorve.videocollage.utils;
    ...
    public Bitmap drawCanvas() {
        ...
        for (int i3 = 0; i3 < Utils.clgstickerviewsList.size(); i3++) {
            try {
                ...
                com.vikram.redactorve.videocollage.BitmapUtils.Utils.width = clgSingleFingerView.getImageWidth();
                ...
                if (bitmapDrawable.getBitmap() != null) {
                    try {
                        ...
                        Bitmap createScaledBitmap = Bitmap.createScaledBitmap(bitmap, com.vikram.redactorve.videocollage.BitmapUtils.Utils.width, imageHeight, true);

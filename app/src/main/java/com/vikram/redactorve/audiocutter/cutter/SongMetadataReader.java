package com.vikram.redactorve.audiocutter.cutter;
...
public class SongMetadataReader {
    ...
    private void a() {
        ...
        Cursor managedQuery = this.mActivity.managedQuery(this.GENRES_URI, new String[]{"_id", str}, null, null, null);
        ...
        String[] strArr2 = {"_id", "title", "artist", "album", "year", "_data"};

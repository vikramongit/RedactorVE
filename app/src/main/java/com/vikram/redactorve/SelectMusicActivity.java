    ...
    @Override public void onCreate(Bundle bundle) {
        ...
        if (externalStorageState.equals("mounted_ro")) {
            ...
            try {
                ...
                this.l.loadAd(new Builder().build());
                if (isOnline()) {
                ...
                try {
                    ...
                    getListView().setOnItemClickListener(new OnItemClickListener() {
                        public void onItemClick(AdapterView adapterView, View view, int i, long j) {
                            int columnIndexOrThrow = SelectMusicActivity.this.d.getColumnIndexOrThrow("_data");
                            String string = SelectMusicActivity.this.d.getString(columnIndexOrThrow);
                            SelectMusicActivity.this.d.getString(columnIndexOrThrow);
                            SelectMusicActivity.this.d.getColumnIndexOrThrow("duration");
                            try {
                                AddAudio.status = 1;
